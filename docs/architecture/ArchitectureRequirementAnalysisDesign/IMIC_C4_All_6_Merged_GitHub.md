...
## 1. Scope & Inputs
- IMIC supports **Policy Holder** and **Agent** via an internet portal and **Company Staff** via an intranet portal.
  AG["Insurance Agent"]
  CS["Company Staff"]
  SA["System Admin"]
...
> Reference deployment aligned to cloud-ready microservices, API gateway, observability, and security posture described in the repository.
