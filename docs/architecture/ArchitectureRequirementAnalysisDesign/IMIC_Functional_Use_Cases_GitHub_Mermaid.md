...
> GitHub renders Mermaid diagrams in Markdown when Mermaid is enabled for the repo.
...
sequenceDiagram
  ...
  note over PH,SYS: Policy is Active; claim can be raised immediately after issuance
